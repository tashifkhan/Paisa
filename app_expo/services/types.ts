...
export interface BackendComparison {
  period_days: number;
  income: { current: number; previous: number; change: number; change_percent: number };
  expense: { current: number; previous: number; change: number; change_percent: number };
...
export interface BackendSimplifiedDebt {
  from_user_id: string;
...
export interface BackendSimplifyDebtsResponse {
  group_id: string;
  group_name: string;
  simplified_debts: BackendSimplifiedDebt[];
