import { MoreHorizontal, Wifi, Cpu, Banknote, CreditCard as CreditCardIcon } from "lucide-react";
...
export const WalletsView = ({ activeWalletTab, setActiveWalletTab }: WalletsViewProps) => (
