    ...
    <div className="flex flex-col h-full bg-(--background) px-6 pt-12 pb-6 overflow-y-auto animate-in fade-in slide-in-from-right duration-300">
      ...
      <div className="flex-1 flex flex-col justify-center items-center max-w-md mx-auto w-full">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-3xl font-bold text-(--foreground) mb-3">Verification</h1>
        ...
        <div className="w-full space-y-6">
          <button 
            ...
            className="w-full py-4 bg-(--primary) text-(--primary-foreground) rounded-[2rem] font-bold text-lg shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
          >
            Verify & Proceed
            <ArrowRight size={20} />
          </button>
    ...
    <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full">
      <div className="mb-10 text-center">
        <div className="relative w-24 h-24 mx-auto mb-6">
          <div className="absolute inset-0 bg-(--primary)/20 rounded-[2rem] rotate-6 blur-sm"></div>
          <div className="relative w-full h-full bg-(--primary) rounded-[2rem] flex items-center justify-center text-(--primary-foreground) shadow-xl">
            <Landmark size={44} />
          </div>
        </div>
      ...
      <div className="space-y-5">
        ...
        <button 
          onClick={() => setCurrentView('home')} 
          className="w-full py-4 bg-(--primary) text-(--primary-foreground) rounded-[2rem] font-bold text-lg shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all mt-4 flex items-center justify-center gap-2"
        >
          Sign In
          <ArrowRight size={20} />
        </button>
  ...
  <div className="flex flex-col h-full bg-(--background) px-6 pt-12 pb-6 overflow-y-auto animate-in fade-in slide-in-from-right duration-300">
    ...
    <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full">
      <div className="mb-10 text-center">
        ...
        <p className="text-(--muted-foreground) text-lg">Start your financial journey</p>
      </div>
      ...
      <div className="space-y-5">
        ...
        <button 
          ...
          className="w-full py-4 bg-(--primary) text-(--primary-foreground) rounded-[2rem] font-bold text-lg shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all mt-6 flex items-center justify-center gap-2"
        >
          Sign Up
          <ArrowRight size={20} />
        </button>
  ...
  <div className="flex flex-col h-full bg-(--background) px-6 pt-12 pb-6 overflow-y-auto animate-in fade-in slide-in-from-right duration-300">
    ...
    <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full">
      <div className="mb-10 text-center">
        ...
        <h1 className="text-3xl font-bold text-(--foreground) mb-3">Reset Password</h1>
      ...
      <div className="space-y-5">
        ...
        <button 
          onClick={() => setCurrentView('otp')} 
          className="w-full py-4 bg-(--primary) text-(--primary-foreground) rounded-[2rem] font-bold text-lg shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all mt-4"
        >
          Send Reset Code
        </button>
      </div>
