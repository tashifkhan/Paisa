...
export const groupService = {
    ...
    async updateGroup(id: string, data: Partial<CreateGroupData>): Promise<BackendGroup> {
    ...
    async addMember(groupId: string, data: AddMemberData): Promise<BackendGroupMember> {
